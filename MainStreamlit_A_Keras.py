...
model = load_model(r'BestModel_MobileNet CNN_A_Keras.h5')
...
st.title("Prediksi Kematangan Buah Pisang")
    ...
    if uploaded_files:
        ...
        for uploaded_file in uploaded_files:
            ...
            if label != "Error":
                ...
                label_color = primary_color if label == "masak" else secondary_color
